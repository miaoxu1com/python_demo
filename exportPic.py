...
class Pyxlchart(object):
    ...
    """
    def __init__(self,WorkbookDirectory,WorkbookFilename,SheetName,CharName,ImageFilename,ExportPath):

        pythoncom.CoInitialize()
        self.WorkbookDirectory = WorkbookDirectory
        self.WorkbookFilename = WorkbookFilename
        self.GetAllWorkbooks = False
        self.SheetName = SheetName
        self.ChartName = CharName
...
#     xl.WorkbookFilename = "ALB_auto_test_20190629165210.xlsx"
#     xl.SheetName = "Sheet1"
...
#     d = os.popen('taskkill /IM excel.exe')
#     print(d.read())
